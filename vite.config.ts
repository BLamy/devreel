...
// Oversize-asset pruning for Cloudflare deploys lives in
// scripts/prune-oversize.mjs (runs after vite build: a closeBundle hook is
// too early — worker sub-builds and the public-dir copy land after it).
